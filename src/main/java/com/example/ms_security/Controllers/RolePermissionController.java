package com.example.ms_security.Controllers;

import com.example.ms_security.Models.RolePermission;
import com.example.ms_security.Services.RolePermissionService;
...
public class RolePermissionController {
    ...
    // CAMBIO: nuevo endpoint para consultar los permisos asignados a un rol.
    ...
    public ResponseEntity<Map<String, String>> addRolePermission(
        ...
        // CAMBIO: ahora distinguimos los tres escenarios posibles.
